...
In Plasma: **System Settings → Application Style → AngelLevel-darkmode**. Combine it
with the AngelLevel-darkmode colour scheme, icon theme, and Aurorae decoration (or
just apply the AngelLevel-darkmode Global Theme) for the complete NeXT desktop.
