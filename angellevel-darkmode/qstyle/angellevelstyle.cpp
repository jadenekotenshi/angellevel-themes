...
AngelLevel-darkmodeStyle::AngelLevel-darkmodeStyle() : QProxyStyle(QStringLiteral("Fusion")) {}

void AngelLevel-darkmodeStyle::polish(QPalette &palette) { applyPalette(palette); }

QPalette AngelLevel-darkmodeStyle::standardPalette() const
{
...
int AngelLevel-darkmodeStyle::pixelMetric(PixelMetric m, const QStyleOption *o, const QWidget *w) const
{
    switch (m) {
...
void AngelLevel-darkmodeStyle::drawPrimitive(PrimitiveElement pe, const QStyleOption *opt,
...
void AngelLevel-darkmodeStyle::drawControl(ControlElement ce, const QStyleOption *opt,
                                     QPainter *p, const QWidget *w) const
{
    switch (ce) {
...
QRect AngelLevel-darkmodeStyle::subControlRect(ComplexControl cc, const QStyleOptionComplex *opt,
...
void AngelLevel-darkmodeStyle::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt,
                                            QPainter *p, const QWidget *w) const
{
    if (cc == CC_ScrollBar) {
