#!/usr/bin/env python3
"""
Generate the AngelLevel-darkmode Plasma Style (desktop theme) FrameSvg widgets:
...
OUT = os.path.join(os.path.dirname(__file__), '..', 'plasma', 'desktoptheme', 'AngelLevel-darkmode')
