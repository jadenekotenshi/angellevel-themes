#!/usr/bin/env python3
"""
Colorize the AngelLevel-darkmode icon theme with an OPENSTEP 4.2-inspired palette.
...
ICONS = os.path.join(os.path.dirname(__file__), '..', 'icons', 'AngelLevel-darkmode')
