#!/usr/bin/env python3
"""
Generate the AngelLevel-darkmode Kvantum SVG (AngelLevel-darkmode.svg). Kvantum looks up
...
"""
import os
OUT = os.path.join(os.path.dirname(__file__), '..', 'kvantum', 'AngelLevel-darkmode')
...
open(os.path.join(OUT, 'AngelLevel-darkmode.svg'), 'w').write(svg)
