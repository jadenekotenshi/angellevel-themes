...
```bash
export QT_STYLE_OVERRIDE=SquirrelLevel-darkmode     # any Qt app in this shell
```

In Plasma: **System Settings → Application Style → SquirrelLevel-darkmode**. Combine it
with the SquirrelLevel-darkmode colour scheme, icon theme, and Aurorae decoration (or
just apply the SquirrelLevel-darkmode Global Theme) for the complete NeXT desktop.
