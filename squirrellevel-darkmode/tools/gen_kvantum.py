#!/usr/bin/env python3
"""
Generate the SquirrelLevel-darkmode Kvantum SVG (SquirrelLevel-darkmode.svg). Kvantum looks up
...
"""
import os
OUT = os.path.join(os.path.dirname(__file__), '..', 'kvantum', 'SquirrelLevel-darkmode')
...
open(os.path.join(OUT, 'SquirrelLevel-darkmode.svg'), 'w').write(svg)
