...
SquirrelLevelStyle::SquirrelLevelStyle() : QProxyStyle(QStringLiteral("Fusion")) {}

void SquirrelLevelStyle::polish(QPalette &palette) { applyPalette(palette); }

QPalette SquirrelLevelStyle::standardPalette() const
{
...
int SquirrelLevelStyle::pixelMetric(PixelMetric m, const QStyleOption *o, const QWidget *w) const
{
    switch (m) {
...
void SquirrelLevelStyle::drawPrimitive(PrimitiveElement pe, const QStyleOption *opt,
                                       QPainter *p, const QWidget *w) const
{
    ...
    case PE_IndicatorCheckBox: {
        paintBevel(p, opt->rect, QColor(Qt::white), true,
...
void SquirrelLevelStyle::drawControl(ControlElement ce, const QStyleOption *opt,
                                     QPainter *p, const QWidget *w) const
{
    switch (ce) {
...
QRect SquirrelLevelStyle::subControlRect(ComplexControl cc, const QStyleOptionComplex *opt,
...
void SquirrelLevelStyle::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt,
                                            QPainter *p, const QWidget *w) const
{
    if (cc == CC_ScrollBar) {
