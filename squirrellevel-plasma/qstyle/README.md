...
In Plasma: **System Settings → Application Style → SquirrelLevel**. Combine it
with the SquirrelLevel colour scheme, icon theme, and Aurorae decoration (or
just apply the SquirrelLevel Global Theme) for the complete NeXT desktop.
