#!/usr/bin/env python3
"""
Colorize the SquirrelLevel icon theme with an OPENSTEP 4.2-inspired palette.
...
ACCENT_RULES = [
    ...
    (r'^weather-snow\.svg$',              [('#5a5a5a', '#8fb0d6')]),
