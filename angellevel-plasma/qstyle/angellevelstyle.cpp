...
AngelLevelStyle::AngelLevelStyle() : QProxyStyle(QStringLiteral("Fusion")) {}

void AngelLevelStyle::polish(QPalette &palette) { applyPalette(palette); }

QPalette AngelLevelStyle::standardPalette() const
{
...
int AngelLevelStyle::pixelMetric(PixelMetric m, const QStyleOption *o, const QWidget *w) const
{
    switch (m) {
...
void AngelLevelStyle::drawPrimitive(PrimitiveElement pe, const QStyleOption *opt,
...
void AngelLevelStyle::drawControl(ControlElement ce, const QStyleOption *opt,
                                     QPainter *p, const QWidget *w) const
{
    switch (ce) {
...
QRect AngelLevelStyle::subControlRect(ComplexControl cc, const QStyleOptionComplex *opt,
...
void AngelLevelStyle::drawComplexControl(ComplexControl cc, const QStyleOptionComplex *opt,
                                            QPainter *p, const QWidget *w) const
{
    if (cc == CC_ScrollBar) {
