...
In Plasma: **System Settings → Application Style → AngelLevel**. Combine it
with the AngelLevel colour scheme, icon theme, and Aurorae decoration (or
just apply the AngelLevel Global Theme) for the complete NeXT desktop.
