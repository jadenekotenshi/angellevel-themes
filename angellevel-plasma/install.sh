...
if [ -d "$SRC/gtk/AngelLevel" ]; then
  install -d "$DATA/themes/AngelLevel"
  cp -R "$SRC/gtk/AngelLevel/"* "$DATA/themes/AngelLevel/"
  echo "  - gtk theme     -> $DATA/themes/AngelLevel/ (apply via kde-gtk-config, or"
