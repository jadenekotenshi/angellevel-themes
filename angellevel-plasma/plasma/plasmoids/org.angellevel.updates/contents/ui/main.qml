/*
 * AngelLevel Updates — a small panel applet that runs angellevel-update-notifier
...
PlasmoidItem {
    ...
    readonly property string notifier: "$HOME/.local/bin/angellevel-update-notifier --print"
