#!/usr/bin/env python3
"""
Generate the AngelLevel Kvantum SVG (AngelLevel.svg). Kvantum looks up
...
"""
import os
OUT = os.path.join(os.path.dirname(__file__), '..', 'kvantum', 'AngelLevel')
...
open(os.path.join(OUT, 'AngelLevel.svg'), 'w').write(svg)
